<p align="center">
  <img alt="hero" src="https://github.com/junhoyeo/use-color/blob/main/.github/assets/hero.png?raw=true" />
  <h1 align="center">🛼 use-color</h1>
</p>

<p align="center">
  <strong>A TypeScript-first, OKLCH-based, framework-agnostic color library <br />that validates color strings at compile time.</strong><br/>
...
<p align="center">
  ...
  <img src="https://github.com/junhoyeo/use-color/blob/main/packages/use-color/badges/coverage-total.svg?raw=true" alt="Coverage" />
</p>

<p align="center">
  <a href="https://colors.junho.io">
    <img src="https://github.com/junhoyeo/use-color/blob/main/.github/assets/playground.png?raw=true" alt="Playground" />
  </a>
</p>
